// Send lockFundsTx and lose locked mosaic
...
function createNoticeTx() {
    ...
    return senderAcc.sign(transferTx, NemConst.NEMESIS_GENERATION_HASH);
}
...
const signedTx = senderAcc.sign(lockFundsTx, NemConst.NEMESIS_GENERATION_HASH);
